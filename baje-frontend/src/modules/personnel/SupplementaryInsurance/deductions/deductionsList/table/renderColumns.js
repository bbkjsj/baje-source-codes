...
import { paymentMethodValues } from "../../const";
  ...
  let columns = [
    ...
    },
    {
      ...
      render: (payment_date, record) => {
        ...
        return record.payment_method === paymentMethodValues.SUNDRY
          ? timeToFa(payment_date, false)
          : record.payment_method === paymentMethodValues.DEDUCTION_OF_CLAIMS
          ? timeToFa(record.document_date, false)
