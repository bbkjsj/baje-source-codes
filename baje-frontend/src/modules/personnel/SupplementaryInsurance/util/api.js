...
const api = endpoints.supplementaryInsurance;
...
const _GET_ExcelReport = () => {
  ...
  return axios.get(api.excelReport, config);
};
...
const _UPDATE_INSURANCE_STATUS = (id, status) => {
  return axios.put(api.updateInsuranceStatus(id), {
    approve: status,
  });
};
