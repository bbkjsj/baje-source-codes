...
import { columns } from "./rejectionCriteriaList/tableColumns";
...
const RejectionCriteriaList = (props) => {
  ...
  const menuBtnList = [
    {
      label: "افزودن معیار رد جدید",
      id: "newCriteria",
      url:
        pageNames.suggest.rejectionCriteria.add +
        "?committee_id=" +
        (pageId || 0),
      variant: "primary",
      icon: <PlusOutlined />,
  ...
  const getPageTitle = () => {
    let title = "مدیریت معیارهای رد پیشنهاد";
        ...
        <div className="card-container">
          <ResponsiveList
            ...
            rowClassName={(record, index) => {
              return !record.is_enable ? "bg-error" : null;
            }}
...
export default RejectionCriteriaList;
